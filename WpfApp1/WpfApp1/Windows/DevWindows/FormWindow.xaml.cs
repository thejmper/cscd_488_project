...
namespace ALInspectionApp.Windows.DevWindows
{
    /// <summary>
    ...
    { 
        ...
        private void formA()
        {
            Form form = new Form("FormA","Pre-Inspection Preparation");
        ...
        private void formB()
        {
            Form form = new Form("FormB","Request For Documentation");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            ...
            form.AddElement(layoutStackPanel);
            LayoutGrid body = new LayoutGrid("body");
            body.AddElement(new ControlBoolean("ombuds", "The field office has contacted the Ombuds. (Attachment A)"), 0, 0, 12);
        ...
        private void formC()
        {
            Form form = new Form("FormC","Resident List");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            layoutStackPanel.AddElement(new ControlBoolean("initial", "Initial"));
            layoutStackPanel.AddElement(new ControlBoolean("full", "Full"));
        ...
        private void formD()
        {
            Form form = new Form("FormD","Resident Characteristic Roster");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlInteger("cencus", "TOTAL CENSUS"));
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            layoutStackPanel.AddElement(new ControlBoolean("initial", "Initial"));
            layoutStackPanel.AddElement(new ControlBoolean("full", "Full"));
            layoutStackPanel.AddElement(new ControlBoolean("followup", "Follow up"));
            ...
            LayoutGrid resident = new LayoutGrid("resident");
            resident.AddElement(new ControlText("resRoom", "RESIDENT ROOM"), 0, 0, 2);
            resident.AddElement(new ControlDate("admitDate", "ADMIT DATE"), 2, 0, 2);
            resident.AddElement(new ControlInteger("resID", "RESIDENT \nID NUMBER"), 4, 0, 2);
            resident.AddElement(new ControlText("resName", "Resident Name"), 6, 0, 6);
            resident.AddElement(new ControlText("moblile", "Mobility / Falls / \nAmbulation Devices"), 0, 1, 2);
            resident.AddElement(new ControlText("behave", "Behavior / Psycho Social Issues"), 1, 1, 1);
            resident.AddElement(new ControlText("dem", "Dementia / Alzheimer’s / Cognitive impairment"), 2, 1, 1);
            resident.AddElement(new ControlText("exit", "Exit Seeking / Wandering"), 3, 1, 1);
            resident.AddElement(new ControlText("smoking", "Smoking"), 4, 1, 1);
            resident.AddElement(new ControlText("dd", "DD / Mental Health"), 5, 1, 1);
            resident.AddElement(new ControlText("lang", "Language / Communication Issue / Deafness \n/ Hearing issues"), 6, 1, 1);
            resident.AddElement(new ControlText("vision", "Vision Deficit / Blindness"), 7, 1, 1);
            resident.AddElement(new ControlText("diabetic", "Diabetic:  Insulin/Non-Insulin"), 8, 1, 1);
            resident.AddElement(new ControlText("adl", "Assist with ADL’s"), 9, 1, 1);
            resident.AddElement(new ControlText("wounds", "Wounds / Skin Issue"), 10, 1, 1);
            resident.AddElement(new ControlText("dialysis", "Incontinent / Appliance (catheter) Dialysis"), 0, 2, 1);
            resident.AddElement(new ControlText("diet", "Special Dietary Needs / Scheduled Snacks"), 1, 2, 1);
            resident.AddElement(new ControlText("weight", "Weight Loss / Weight Gain"), 2, 2, 1);
            resident.AddElement(new ControlText("devices", "Medical Devices "), 3, 2, 1);
            resident.AddElement(new ControlText("pay", "Pay Status:  Private = P  State = S"), 4, 2, 1);
            resident.AddElement(new ControlText("hospital", "Recent Hospitalization"), 5, 2, 1);
            resident.AddElement(new ControlText("oxy", "Oxygen / Respiratory Therapy"), 6, 2, 1);
            resident.AddElement(new ControlText("home", "Home Health / Hospice / Private Caregiver"), 7, 2, 1);
            resident.AddElement(new ControlText("other", "Other"), 8, 2, 1);
            resident.AddElement(new ElementSpacer("space", 10), 0, 3, 12);
            LayoutRepeatGrid residnets = new LayoutRepeatGrid("residents", new FormElement[] { resident }, "Add Resident");
            form.AddElement(residnets);

            LayoutGrid footer = new LayoutGrid("footer");
            footer.AddElement(new ControlLabel("lab1", "Coding:	In order to assist in more accurate communication of resident characteristics, the following coding legend has been provided.  \nIf characteristics do not apply, leave box blank."), 0, 0, 12, false);
            footer.AddElement(new ControlLabel("labA1", "Nursing Services\n(services only a licensed nurse can provide)"), 0, 1, 4);
            footer.AddElement(new ControlLabel("labB1", "O - resident receiving Ostomy care; T - resident receiving Tube feeding; I – resident receiving Injections; \nND – resident receiving Nurse Delegation."), 4, 1, 8);
            footer.AddElement(new ControlLabel("labA2", "Medication:	Independent	Administration\n    Assistance  Family Assistance"), 0, 2, 4);
            footer.AddElement(new ControlLabel("labB2", "I – resident assessed as Independent with their medication; A – resident assessed as needing medication assistance;\nAD – resident assessed medication administration; F – resident receiving Family assistance with medications."), 4, 2, 8);
            footer.AddElement(new ControlLabel("labA3", "Mobility / Falls / Ambulation Devices"), 0, 3, 4);
            footer.AddElement(new ControlLabel("labB3", "A – resident requires Assistance with transfers or cannot ambulate independently without assistance from staff or assistive \ndevices; F – resident experienced a Fall within the last 30 days; D – resident uses a Device to assist with ambulation."), 4, 3, 8);
            footer.AddElement(new ControlLabel("labA4", "Behavior / Psycho Social Issues"), 0, 4, 4);
            footer.AddElement(new ControlLabel("labB4", "X – resident shows or has behaviors such as those requiring special training or assistance increasing the amount of time staff \nneeds to assist resident."), 4, 4, 8);
            footer.AddElement(new ControlLabel("labA5", "Dementia / Alzheimer’s / Cognitive impairment"), 0, 5, 4);
            footer.AddElement(new ControlLabel("labB5", "X – resident shows or has behaviors requiring special training or assistance increasing the amount of time staff needs to \nassist resident."), 4, 5, 8);
            footer.AddElement(new ControlLabel("labA6", "Exit Seeking / Wandering"), 0, 6, 4);
            footer.AddElement(new ControlLabel("labB6", "ES – resident has shown Exit Seeking behaviors; W – resident has shown Wandering behaviors"), 4, 6, 8);
            footer.AddElement(new ControlLabel("labA7", "Smoking"), 0, 7, 4);
            footer.AddElement(new ControlLabel("labB7", "S – resident Smokes."), 4, 7, 8);
            footer.AddElement(new ControlLabel("labA8", "DD / Mental Health"), 0, 8, 4);
            footer.AddElement(new ControlLabel("labB8", "DD – resident has a Developmental Disability case manager; MH – resident receives Mental Health services and/or has a \nmental health case manager."), 4, 8, 8);
            footer.AddElement(new ControlLabel("labA9", "Language / Communication Issues / Deafness /\n Hearing Issues"), 0, 9, 4);
            footer.AddElement(new ControlLabel("labB9", "X – resident has a language or communication issue which requires additional staff support; HI – resident is Hearing Impaired; \nD – resident is Deaf."), 4, 9, 8);
            footer.AddElement(new ControlLabel("labA10", "Vision Deficit / Blindness"), 0, 10, 4);
            footer.AddElement(new ControlLabel("labB10", "X – resident if blind or has severe vision deficit which requires additional staff support"), 4, 10, 8);
            footer.AddElement(new ControlLabel("labA11", "Diabetic:  Insulin / Non-Insulin"), 0, 11, 4);
            footer.AddElement(new ControlLabel("labB11", "I – resident if Insulin dependent; N – resident is Non-insulin dependent diabetic."), 4, 11, 8);
            footer.AddElement(new ControlLabel("labA12", "Assist with ADL’s"), 0, 12, 4);
            footer.AddElement(new ControlLabel("labB12", "I – resident assessed as Independent; MIN – resident assessed as needing MINimal assistance with ADL’s such as curing reminders\n, supervision, and/or encouragement; MOD – resident assessed as needing  MODerate assistance with ADL’s such \nas guiding, standby assistance for transfers, or ambulation, bathing and toileting; MAX – resident assessed as needing \nMAXimum assistance with ADL’s such as needing a one person or two person transfer, resident was incontinent of bowel or \nbladder and required staff to assist with care; resident needed assistance with turning, sitting up or laying down, staff must \nphysically turn the resident every two hours."), 4, 12, 8);
            footer.AddElement(new ControlLabel("labA13", "Wounds / Skin Issue"), 0, 13, 4);
            footer.AddElement(new ControlLabel("labB13", "P – resident has a Pressure ulcer; S – resident has a Stasis wound; W – resident has a Wound or skin issue other than \npressure or stasis ulcer."), 4, 13, 8);
            footer.AddElement(new ControlLabel("labA14", "Incontinent / Appliance (catheter) / Dialysis"), 0, 14, 4);
            footer.AddElement(new ControlLabel("labB14", "UI – resident Incontinent of bladder and/or bowel; C – resident has Catheter; D – resident requires Dialysis."), 4, 14, 8);
            footer.AddElement(new ControlLabel("labA15", "Special Dietary Needs / Scheduled Snacks"), 0, 15, 4);
            footer.AddElement(new ControlLabel("labB15", "X – resident requires a special prescribed diet."), 4, 15, 8);
            footer.AddElement(new ControlLabel("labA16", "Weight Loss / Weight Gain"), 0, 16, 4);
            footer.AddElement(new ControlLabel("labB16", "WL – resident has had more than a 3 – 5 pound Weight Loss within last 60 days; WG – resident has had more than a 3 – 5 \npound Weight Gain within the last 60 days."), 4, 16, 8);
            footer.AddElement(new ControlLabel("labA17", "Medical Devices"), 0, 17, 4);
            footer.AddElement(new ControlLabel("labB17", "X – resident receives dialysis treatments; M – if part of a residents care is the use of side rails, transfer poles, chair / bed \nalarms / belt restraints."), 4, 17, 8);
            footer.AddElement(new ControlLabel("labA18", "Pay Status"), 0, 18, 4);
            footer.AddElement(new ControlLabel("labB18", "P – all or part of a resident’s care is paid by the resident or their family; S – all of part of a resident care is paid for by the state."), 4, 18, 8);
            footer.AddElement(new ControlLabel("labA19", "Recent Hospitalization"), 0, 19, 4);
            footer.AddElement(new ControlLabel("labB19", "X – resident has been hospitalized within the last 60 days."), 4, 19, 8);
            footer.AddElement(new ControlLabel("labA20", "Oxygen / Respiratory Therapy"), 0, 20, 4);
            footer.AddElement(new ControlLabel("labB20", "X – resident receives oxygen and/or respiratory therapy or treatments."), 4, 20, 8);
            footer.AddElement(new ControlLabel("labA21", "Home Health / Hospice / Private Caregiver"), 0, 21, 4);
            footer.AddElement(new ControlLabel("labB21", "HH – resident receives Home Health services; HOS – resident receives HOSpice services; P – resident receives care from \nPrivate caregiver."), 4, 21, 8);
        ...
        private void formE()
        {
            Form form = new Form("FormE","Resident Group Meeting");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            layoutStackPanel.AddElement(new ControlBoolean("full", "Full"));
            form.AddElement(layoutStackPanel);
            ...
            body.AddElement(new ControlText("cPrez", "COUNCIL PRESIDENT"), 2, 1, 6);
        ...
        private void formG()
        {
            Form form = new Form("FormG","Resident Interview");
        ...
        private void formH()
        {
            Form form = new Form("FormH","Other Contact Interview");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            layoutStackPanel.AddElement(new ControlBoolean("initial", "Initial"));
            layoutStackPanel.AddElement(new ControlBoolean("full", "Full"));
        ...
        private void formI()
        {
            Form form = new Form("FormI","Enviromental Observations");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            layoutStackPanel.AddElement(new ControlBoolean("initial", "Initial"));
            layoutStackPanel.AddElement(new ControlBoolean("full", "Full"));
            ...
            LayoutGrid body = new LayoutGrid("body");
            body.AddElement(new ControlLabel("lab1", "Quality of Life/Resident Rights"), 0, 0, 12, true);
        ...
        private void formJ()
        {
            Form form = new Form("FormJ","Resident Record Review");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            layoutStackPanel.AddElement(new ControlBoolean("initial", "Initial"));
            layoutStackPanel.AddElement(new ControlBoolean("full", "Full"));
        ...
        private void formK()
        {
            Form form = new Form("FormK","Staff Sample/Record Review");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            layoutStackPanel.AddElement(new ControlBoolean("initial", "Initial"));
            layoutStackPanel.AddElement(new ControlBoolean("full", "Full"));
        ...
        private void formL()
        {
            Form form = new Form("FormL","Notes/Worksheet");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            layoutStackPanel.AddElement(new ControlBoolean("initial", "Initial"));
            layoutStackPanel.AddElement(new ControlBoolean("full", "Full"));
        ...
        private void formM()
        {
            Form form = new Form("FormM","Exit Preparation Worksheet");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            layoutStackPanel.AddElement(new ControlBoolean("initial", "Initial"));
            layoutStackPanel.AddElement(new ControlBoolean("full", "Full"));
        ...
        private void formN()
        {
            Form form = new Form("FormN","Contact Requirements");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            layoutStackPanel.AddElement(new ControlBoolean("initial", "Initial"));
            layoutStackPanel.AddElement(new ControlBoolean("full", "Full"));
        ...
        private void formO()
        {
            Form form = new Form("FormO","Enviromental Observations-Contract Requirements");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            layoutStackPanel.AddElement(new ControlBoolean("initial", "Initial"));
            layoutStackPanel.AddElement(new ControlBoolean("full", "Full"));
        ...
        private void formP()
        {
            Form form = new Form("FormP","Food Service Observations");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            layoutStackPanel.AddElement(new ControlBoolean("initial", "Initial"));
            layoutStackPanel.AddElement(new ControlBoolean("full", "Full"));
        ...
        private void formQ()
        {
            Form form = new Form("FormQ","Medication Pass Worksheet");
            LayoutStackPanel layoutStackPanel = new LayoutStackPanel("inspectionType");
            layoutStackPanel.AddElement(new ControlLabel("lab1", "Inspection Type"));
            layoutStackPanel.AddElement(new ControlBoolean("initial", "Initial"));
            layoutStackPanel.AddElement(new ControlBoolean("full", "Full"));
...
//below is the code to recreate the forms. just paste them above the string filename line
